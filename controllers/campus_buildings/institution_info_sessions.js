...
export const createInstitutionInfoSession = async (req, res) => {
    try {
        const newSession = new InstitutionInfoSession(req.body);
        const savedSession = await newSession.save();
        sendSuccess(res, "Session created successfully", savedSession, 201);
    } catch (err) {
        sendError(res, "Failed to create session", err.message, 400);
    }
};

//GET: retrieve all sessions
export const getAllInstitutionInfo = async (req, res) => {
    try {
...
export const getOneInstitutionInfo = async (req, res) => {
    try {
...
export const updateInstitutionInfoSession = async (req, res) => {
    try {
...
export const deleteInstitutionInfoSession = async (req, res) => {
    try {
        ...
        sendSuccess(res, "Session deleted successfully", deletedSession, 200);
    } catch (err) {
